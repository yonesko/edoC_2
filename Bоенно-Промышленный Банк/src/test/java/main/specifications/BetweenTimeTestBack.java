 ...
 */
public class BetweenTimeTestBack {
    private static Payment paymentsIn[] = new Payment[]{
            ...
            new Payment(ranValue(), Instant.parse("1970-01-01T23:54:00Z"), ranProd(), ranCli())};
    ...
    private static Payment paymentsNotIn[] = new Payment[]{
            ...
            new Payment(ranValue(), Instant.parse("9016-01-21T19:59:59.999Z"), ranProd(), ranCli()),
            new Payment(ranValue(), Instant.parse("2706-06-01T20:00:00.001Z"), ranProd(), ranCli()),
            new Payment(ranValue(), Instant.parse("1716-06-01T21:49:08.039Z"), ranProd(), ranCli()),
            new Payment(ranValue(), Instant.parse("2016-06-01T19:35:00.001Z"), ranProd(), ranCli())};
    @Test
    public void isSatisfiedBy() throws Exception {
        ISpecification spec = new BetweenTime(LocalTime.of(23, 54), LocalTime.of(19, 35));
